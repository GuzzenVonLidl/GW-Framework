...
_Box addItemCargoGlobal ["ACE_epinephrine",50];
_Box addItemCargoGlobal ["ACE_morphine",50];
_Box addItemCargoGlobal ["ACE_quikclot",50];
_Box addItemCargoGlobal ["ACE_salineIV",50];
_Box addItemCargoGlobal ["ACE_tourniquet",50];