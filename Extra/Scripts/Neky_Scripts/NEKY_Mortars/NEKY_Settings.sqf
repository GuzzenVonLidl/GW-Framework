...
_DangerClose = 75;											// Range from which the unit will react to enemy forces and dismount static weapon.									Number (meters)
...
_PreciseReloadTime = 100;									// The time it takes for the mortar to prepare for another strike after performing a Precise strike.				Number (seconds)
_BarrageSize = [8,10,12];									// Randomly selected number of mortars per barrage.																	Array of numbers (mortars)
_BarrageReloadTime = 150;									// The time it takes for the mortar to prepare for another strike after performing a Barrage.						Number (seconds)
...
_SporadicReloadTime = 80;									// The time it takes for the mortar to prepare for another strike after performing a Sporadic strike.				Number (seconds)
...
_GuidedReloadTime = 120;									// The time it takes for the mortar to prepare for another strike after performing a Guided strike.					Number (seconds)
