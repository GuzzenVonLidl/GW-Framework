...
{
	if (isNull _x) then {VCOMAI_ArtilleryArray = VCOMAI_ArtilleryArray - [_x];};
} foreach VCOMAI_ArtilleryArray;

//Hint format ["%1",VCOMAI_ArtilleryArray];
...
if !(_ReturnedSupport in VCOMAI_ArtilleryArray) exitWith {};
...

{
	...
	{
		[_x,"I am firing my ARTY >:D!!!",120,20000] remoteExec ["VCOMAI_3DText",0];
	};
