private ["_Unit", "_RandomChance", "_myNearestEnemy", "_VCOMAI_GRENADETHROWN", "_CheckDistance", "_DirectionSet", "_Directionset"];

_Unit = _this select 0;
_VCOMAI_GRENADETHROWN = _this select 1;

_RandomChance = (round (random 100));

if (_RandomChance < VCOMAI_GRENADECHANCE) then
{
