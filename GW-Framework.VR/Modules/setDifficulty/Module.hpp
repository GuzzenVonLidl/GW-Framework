#include "script_Component.hpp"
	...
	class Behaviour {
		...
		class Specialforces {
			...
			aimingShake[]	 = {0.40, 0.50, 0.60};
			aimingSpeed[]	 = {0.40, 0.50, 0.60};
		...
		class Military {
			...
			spotDistance[]	 = {0.60, 0.80, 0.90};
			spotTime[]		 = {0.60, 0.80, 0.90};
