...
switch (toLower(_role)) do {
	...
	case "fac": {
		...
		[[_rifle_mag_tr,3],[_smokegrenadeY,6],[_smokegrenadeG,6],[_smokegrenadeR,3],[_smokegrenadeB,2],[_smokegrenadeO,2],[_smokegrenadeP,2]] call _addToVest;
	...
	case "sl": {
		[_goggles,_helmet,_uniform,_vest,_backpackRadio] call _addEquipment;
		[_rifleGL, _rifle_mag, _glHE] call _addPrimary;
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_smokegrenadeG,4],[_grenademini,2],[_grenade,2],[_rifle_mag_tr,5]] call _addToVest;
