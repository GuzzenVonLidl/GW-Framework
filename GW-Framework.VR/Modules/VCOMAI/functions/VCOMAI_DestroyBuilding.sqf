...
//_Point = _Unit getVariable "VCOMAI_CLOSESTENEMY";
...
_SatchelOfUse = _Unit getVariable "VCOMAI_SATCHELBOMB";
//Hint format ["_SatchelOfUse %1",_SatchelOfUse];

if (VCOMAI_AIDEBUG isEqualTo 1) then
{
	[_Unit,"Blowing up a building! >:D!!!!",30,20000] remoteExec ["VCOMAI_3DText",0];
};
...
*/
_Bomb = _Unit getVariable "VCOMAI_SATCHELBOMB";
_RemoveMag = _Unit getVariable "VCOMAI_SatchelObjectMagazine";
