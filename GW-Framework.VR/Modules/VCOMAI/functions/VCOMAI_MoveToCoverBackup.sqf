...
if ((_VCOMAI_InCover) || {_VCOMAI_MovedRecentlyCover} || {_Unit getVariable "VCOMAI_ActivelyClearing"} || {_VCOMAI_StartedInside} || {_Unit getVariable "VCOMAI_GARRISONED"} || !(vehicle _Unit isEqualTo _Unit)) exitWith {};
