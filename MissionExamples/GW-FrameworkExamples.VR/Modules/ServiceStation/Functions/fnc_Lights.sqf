...
private ["_Index","_45","_10","_Pos","_Spheres","_y","_Light"];
params ["_SS"];

While {_SS In GVAR(Active) && BLINKINGLIGHTS} do {
	_Index = 0;
	_45 = 45;
	_10 = 10;
	_Pos = GetPos _SS;
	...
	if !(_SS In GVAR(Active)) exitWith { {deleteVehicle _x} forEach _Spheres };
	_Index = 0;
